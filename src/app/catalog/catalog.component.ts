...
export class CatalogComponent  {
  ...
  constructor(private productsService: ProductsService, private cartService: CartService ) { // short hand version of declaring a private class field, thanks to typescript
